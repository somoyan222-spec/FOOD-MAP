...
export const MemphisPattern: React.FC = () => {
  const shapes = [
    ...
    { type: "wave", color: "#C3B1E1", width: 150, top: "15%", left: "60%", delay: "0.3s" },
    { type: "wave", color: "#FF6B6B", width: 120, top: "45%", left: "20%", delay: "1.3s" },
    { type: "wave", color: "#98D9C2", width: 100, bottom: "20%", right: "30%", delay: "2.3s" },
